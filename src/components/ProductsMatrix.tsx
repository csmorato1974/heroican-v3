      ...
      <div className="mx-auto max-w-6xl px-4 py-20 sm:py-24">
        ...
        <div className="mt-12 brand-card p-6 sm:p-8">
          ...
          <p className="mt-4 text-sm text-foreground/70 leading-relaxed">
            Heroican combina proteína animal de alta digestibilidad con cereales seleccionados y aditivos funcionales, aportando un equilibrio completo de proteínas, grasas, fibra y minerales en todas sus presentaciones. Los valores nutricionales (proteína, grasa, fibra, humedad, ceniza, calcio y fósforo) varían levemente según la etapa de vida, el tamaño y la raza.
          </p>
        </div>
