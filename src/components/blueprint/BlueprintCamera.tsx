  ...
  return (
    ...
    >
      ...
      <span
        ...
        } max-w-[6.5rem] sm:max-w-[8rem] whitespace-normal text-[9px] sm:text-[10px] leading-tight font-bold text-foreground bg-card/95 backdrop-blur px-2 py-1 rounded-full border border-border shadow-sm pointer-events-none ${
